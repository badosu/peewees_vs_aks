...
VFS.Include("LuaHandler/Utilities/system.lua", nil, VFSMODE)
...
function addon.Initialize()
	Spring.Log(section, LOG.INFO, string.format("Loading gadget: %-18s  <%s>", addon._info.name, addon._info.basename))
	...
	for i = 1, #allUnits do
		...
		addon.UnitCreated(unitID, Spring.GetUnitDefID(unitID))
	end
end

function addon.UnitCreated(unitID, unitDefID)
